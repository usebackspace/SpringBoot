...
public class OrderController {
    ...
    public OrderController(OrderRepository orderRepository, ProductRepository productRepository, AddressRepository addressRepository, UserRepository userRepository) {
    ...
    public String updateOrderForm(@PathVariable Long id, Model model) {
        ...
        model.addAttribute("products", productRepository.findAll());  // Add all available products
